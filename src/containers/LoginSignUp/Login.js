...
import {  Card, CardImg, CardTitle, CardText, CardDeck,
  CardSubtitle, CardBody, Jumbotron } from "reactstrap";
...
const Login = (props) => {
  ...
  return (
    <>
      <LoginSignupNavbar/>
      <br></br>
      <h3 style={{color:"white" }}> Welcome to Garduino- A smart gardening system  </h3><br></br>
      <h4 style={{textAlign:"left", paddingLeft:50, color:"whitesmoke"}}>A Glimpse of who we are and what we have to Offer:</h4><br></br>
      <pre style={{textAlign:"left", color:"whitesmoke"}}> It all started with a resolve to use the umpteen opportunities offered by technology 
      in doing something for the society. </pre>
      <pre style={{textAlign:"left", color:"whitesmoke"}}> Our Government has been making numerous attempts to encourage households to indulge in urban farming through automation.<br></br><br></br> Researchers have predicted that:<br></br>
       <br></br>- A family that practices gardening tends to be more inclined towards adopting a healthy lifestyle.<br></br><br></br>
       - Home gardening promotes values of science, environmental stewardship and healthy eating among children. <br></br>

       </pre>
       <br></br><br></br>
        <h2 style={{color:"white", textAlign:"left"}}>The Key Features that Our system has are depicted below:</h2><br></br>
