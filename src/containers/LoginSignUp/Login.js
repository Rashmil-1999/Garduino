        ...
        <div class="column column-12 sm:column-6 md:column-6 mb-3">
            ...
            <div class="column column-12 sm:column-8 is-centered text-centered mb-3">
                    <div class="box mb-3 rounded-3">
                        <h3 class="h3 text-primary mb-2 relative delimiter-bottom-dark">Our Vision And Mission </h3>
                ...
                and healthy eating among children"</p>
                  <h3 class="h3 text-primary mb-2 relative delimiter-bottom-dark"> Contact details:</h3>
                  <p class="text-grey">
